...
class _PhotoCropScreenState extends State<PhotoCropScreen>
  ...
  void initState() {
    ...
    Image.file(File(widget.arguments.imagePath))
        .image
  ...
  void _handleScaleStart(ScaleStartDetails d) {
    if (d.pointerCount == 1) {
      ...
      _isMovingLeftCorner =
          cropRect.center.dx * targetScale > d.focalPoint.dx - _offset!.dx;
      _isMovingTopCorner =
          cropRect.center.dy * targetScale > d.focalPoint.dy - _offset!.dy;

      _previousMoveCornerOffset =
          d.focalPoint; //Offset(cropRect.left, cropRect.top);
    } else {
  ...
  void _handleScaleUpdate(ScaleUpdateDetails d) {
    if (d.pointerCount == 1) {
      ...
      final dx =
          (d.focalPoint.dx - _previousMoveCornerOffset!.dx) / targetScale;
      final dy =
          (d.focalPoint.dy - _previousMoveCornerOffset!.dy) / targetScale;
      ...
      _previousMoveCornerOffset = d.focalPoint;
    } else {
...
class _ZoomableImagePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size canvasSize) {
    ...
    var paint = Paint()
      ...
      ..color = CashbackColors.photoCropBorderColor;
